...
const chevronLeftIcon = (color: string) => {
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-left"><path d="m15 18-6-6 6-6"/></svg>`
}

const chevronRightIcon = (color: string) => {
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg>`
}
...
const checkIcon = (color: string) => {
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check-icon lucide-check"><path d="M20 6 9 17l-5-5"/></svg>`
}
...
export const Icon = (props: IconProps) => {
    ...
    const iconMap = {
        ...
        chevronLeft: chevronLeftIcon(color),
        chevronRight: chevronRightIcon(color),
        circleUser: circleUserIcon(color),
        home: homeIcon(color),
        moon: moonIcon(color),
        sun: sunIcon(color),
        check: checkIcon(color),
    }
